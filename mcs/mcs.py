...
def mcs(fcn, u, v, smax, nf, stop, iinit, local, gamma, hess, prt=1):
    ...
    ipar, level, ichild, f, isplit, p, xbest, fbest, nboxes = initbox(x0, f0, l, L, istar, u, v, isplit, level, ipar,
                                                                      ichild, f, nboxes, prt)
        ...
        if splt == 1:  # prepare for splitting
            ...
            if z[1, par] == np.Inf:  # prepare for splitting by initialization list
                ...
                xbest, fbest, f01, xmin, fmi, ipar, level, ichild, f, flag, ncall1, record, nboxes, nbasket, nsweepbest, nsweep = splinit(
                    fcn, i, s, smax, par, x0, n0, u, v, x, y, x1, x2, L, l, xmin, fmi, ipar, level, ichild, f, xbest,
                    fbest, stop, prt, record, nboxes, nbasket, nsweepbest, nsweep)
                ...
                z[0, par] = x[i]
                xbest, fbest, xmin, fmi, ipar, level, ichild, f, flag, ncall1, record, nboxes, nbasket, nsweepbest, nsweep = split(
                    fcn, i, s, smax, par, n0, u, v, x, y, x1, x2, z[:, par], xmin, fmi, ipar, level, ichild, f, xbest,
                    fbest, stop, prt, record, nboxes, nbasket, nsweepbest, nsweep)
            ...
            if local:
                ...
                for j in range(nbasket0 + 1, nbasket + 1):
                    ...
                    if loc:
                        ...
                        xbest, fbest, xmin, fmi, x, f1, loc, flag, ncall1, nsweep, nsweepbest = basket(fcn, x, f1, xmin,
                                                                                                       fmi, xbest,
                                                                                                       fbest, stop,
                                                                                                       nbasket0, nsweep,
                                                                                                       nsweepbest)
                        ...
                        if not flag:
                            break
                        if loc:
                            xmin1, fmi1, nc, flag, nsweep, nsweepbest = lsearch(fcn, x, f1, f0min, u, v, nf - ncall,
                                                                                stop, local, gamma, hess, nsweep,
                                                                                nsweepbest)
                            ncall = ncall + nc
                            ncloc = ncloc + nc
                            if fmi1 < fbest:
                            ...
                            xbest, fbest, xmin, fmi, loc, flag, ncall1, nsweep, nsweepbest = basket1(fcn, xmin1, fmi1,
                                                                                                     xmin, fmi, xbest,
                                                                                                     fbest, stop,
                                                                                                     nbasket0, nsweep,
                                                                                                     nsweepbest)
