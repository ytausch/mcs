...
def minq(gam, c, G, xu, xo, prt):
    ...
    while 1:
        ...
        if not improvement or nitref > nitrefmax:
            ...
            subdone = 0
            nsub, free, L, dd, K, G, n, g, x, xo, xu, convex, xx, fct, nfree, alp, alpu, alpo, lba, uba, ier, unfix, subdone = minqsub(
                nsub, free, L, dd, K, G, n, g, x, xo, xu, convex, xx, fct, nfree, unfix, alp, alpu, alpo, lba, uba, ier,
                subdone)
            if not subdone:
                return x, fct, ier
            if ier:
