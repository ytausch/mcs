...
def gls(func, xl, xu, x, p, alist, flist, nloc, small, smax, prt=2):
    ...
    # plt.plot(aa,ff)
    alist, flist, alp, alp1, alp2, falp = lsinit(func, x, p, alist, flist, amin, amax,
                                                 scale)  # 2 points needed for lspar and lsnew
    ...
    while s < min(5, smax):
        if nloc == 1:
            ...
            alist, flist, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s, alp, fac = lspar(func, nloc,
                                                                                                             small,
                                                                                                             sinit,
                                                                                                             short, x,
                                                                                                             p, alist,
            ...
            alist, flist, alp, fac = lsnew(func, nloc, small, sinit, short, x, p, s, alist, flist, amin, amax, alp,
                                           abest, fmed, unitlen)
            alist, flist, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s = lssort(alist, flist)
        # print('while \n:')
        # print(alist,flist,abest,fbest,fmed,up,down,monotone,minima,nmin,unitlen,s)
    ...
    if nmin == 1:
        ...
        if s == 5:
            ...
            alist, flist, amin, amax, alp, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s, good, saturated = lsquart(
                func, nloc, small, sinit, short, x, p, alist, flist, amin, amax, alp, abest, fbest, fmed, up, down,
                monotone, minima, nmin, unitlen, s, saturated)
            # check descent condition
        alist, flist, alp, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s = lsdescent(func, x, p,
                                                                                                        alist, flist,
                                                                                                        alp, abest,
                                                                                                        fbest, fmed, up,
                                                                                                        down, monotone,
    ...
    while 1:
        ...
        if not saturated and nloc > 1:
            ...
            alist, flist, amin, amax, alp, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s = lssep(
                func, nloc, small, sinit, short, x, p, alist, flist, amin, amax, alp, abest, fbest, fmed, up, down,
                monotone, minima, nmin, unitlen, s)
        # local interpolation step
        alist, flist, alp, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s, saturated = lslocal(func,
                                                                                                                 nloc,
                                                                                                                 small,
                                                                                                                 sinit,
                                                                                                                 short,
