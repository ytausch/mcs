...
# ------------------------------------------------------------------------------
def lssep(func, nloc, small, sinit, short, x, p, alist, flist, amin, amax, alp, abest, fbest, fmed, up, down, monotone,
    ...
    for times in range(0, nmin - nsep):
        ...
        # print('extrapolation')
        alist, flist, alp, fac = lsnew(func, nloc, small, sinit, short, x, p, s, alist, flist, amin, amax, alp, abest,
                                       fmed, unitlen)
        alist, flist, abest, fbest, fmed, up, down, monotone, minima, nmin, unitlen, s = lssort(alist, flist)
